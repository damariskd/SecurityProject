...
<select data-placeholder="Choose a Language..." onchange="location = this.value;" >
    <option value="ransomware">  English</option>
    <option value="ransomwareDE">German</option>
    <option value="ransomwareRO">Romanian</option>
</select>
<h1>Phishing</h1>
...
<div class="topnav">
    ...
    <input type="text" placeholder="Cautare, cuvinte cheie, text...">
...
<div class = "descrTopics" >
    <%
        FileInputStream fis = new FileInputStream("Ransomware_ro.docx");
