...
<select data-placeholder="Choose a Language..." onchange="location = this.value;" >
    <option value="phishing">  English</option>
    <option value="phishingDE">German</option>
    <option value="phishingRO">Romanian</option>
</select>
<h1>Phishing</h1>
...
<div class = "descrTopics" >
    <%
        FileInputStream fis = new FileInputStream("Phishing_ro.docx");
