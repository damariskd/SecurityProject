...
<select data-placeholder="Choose a Language..." onchange="location = this.value;" >
    <option value="dos_ddos">  English</option>
    <option value="dos_ddosDE">German</option>
    <option value="dos_ddosRO">Romanian</option>
</select>
<h1>Atacuri Denial-of-Service si Distributed-Denial-of-Service</h1>


<div class="topnav">
    <a href="indexRO.jsp">Home</a>
    <a href="aboutRO.jsp">About</a>
...
<div class = "descrTopics" >
    <%
        FileInputStream fis = new FileInputStream("DoS_DDoS_ro.docx");
