...
<div class="topnav">
    ...
    <input type="text" placeholder="Cauta cuvinte cheie, text..">
...
<ul class="topics">
    ...
    <br>
    <li> <a href="typesOfAttacksRO">Classification of Threats</a></li>
    <br>
    ...
    <br>
    <li> <a href="trojan_horseRO">Trojan Horse</a></li>
    <br>
    <li> <a href="#gdpr">Man-in-the-middle attack</a></li>
    <br>
    <li> <a href="#gdpr">Man-in-the-browser attack</a></li>
    <br>
    <li> <a href="dos_ddosRO">Denial-of-service/Distributed-denial-of-service attack (DOS/DDOS)</a></li>
    <br>
